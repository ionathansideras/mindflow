        ...
        <header
            className={`fixed top-0 left-0 w-full z-50 border-b border-n-6
                 lg:bg-n-8/90 lg:backdrop-blur-sm ${
                     open ? "bg-n-8" : "bg-n-8/90 blackdrop-blur-sm"
                 }`}
        >
                    ...
                    <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
                        {navigation.map((item) => (
                            <a
                                ...
                                href={item.url}
                                onClick={handleClick}
                                className={`block relative font-code text-2lx uppercase text-n-1 
                                    transition-colors hover:text-color-1 cursor-pointer ${
